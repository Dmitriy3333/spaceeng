...
var disc = function () { 
    if (i < 6) {
      discription = "<p>Плохой результат! <br> Вы не справились с тестом! <br> Очень жаль. попробуйте снова!</p>";
    } else if (i >= 6 && i <= 11) {
      discription = "<p>Ваш результат не очень хороший! <br> Попробуйте пройти тест ещё раз! <br> Я уверен - у вас получится улучшить результат!</p>";
    } else if (i >= 12 && i < 15) {
      discription = "<p>У Вас очень хороший результат! <br> Хорошее прохождение теста! <br> Вы достаточно близки к <br> Космической инженерии!</p>";
    } else {
      discription = "<p>Отличный результат! <br> Вы набрали максимум баллов! <br> Вы очень близки к <br> Космической инженерии!</p>"
    }
  } 
